...
"QPushButton{color: rgb(255, 255, 255);}")
        ...
        self.horizontalLayout_4.addWidget(self.left_container)
...
"}")
        ...
        self.gridLayout.addWidget(self.btn_salvar_receita, 2, 5, 1, 1)
...
"color: #000000")
        ...
        self.gridLayout.addWidget(self.tableWidget_criar, 1, 0, 1, 6)
...
"}")
        ...
        self.gridLayout.addWidget(self.btn_calcular, 3, 5, 1, 1)
        ...
        self.label_valor_unitario.setFont(font5)
...
"padding-left: 5px")
        ...
        self.gridLayout.addWidget(self.lineEdit_qtd, 0, 5, 1, 1)
...
"padding-left: 5px")
        ...
        self.lineEdit_lucro.setMinimumSize(QSize(120, 20))
        self.lineEdit_lucro.setMaximumSize(QSize(120, 16777215))
        font7 = QFont()
        font7.setPointSize(10)
        self.lineEdit_lucro.setFont(font7)
...
"padding-left: 5px")
        ...
        self.gridLayout.addWidget(self.lineEdit_lucro, 0, 3, 1, 1)
...
"")
        ...
        self.gridLayout.addWidget(self.btn_limpar, 4, 5, 1, 1)

        self.label_msg_salvo = QLabel(self.pg_criar)
        self.label_msg_salvo.setObjectName(u"label_msg_salvo")

        self.gridLayout.addWidget(self.label_msg_salvo, 2, 2, 1, 3)
...
"border-radius: 5px;")
        ...
        self.error_label.setFont(font7)
...
"border-radius: 5px;")
        ...
        sizePolicy2.setHeightForWidth(self.tableWidget_produtos.sizePolicy().hasHeightForWidth())
        self.tableWidget_produtos.setSizePolicy(sizePolicy2)
        self.tableWidget_produtos.setMinimumSize(QSize(0, 0))
        ...
        self.frame_2_tab2.setMaximumSize(QSize(100, 16777215))
...
"border-radius: 12px")
        ...
        self.horizontalLayout_4.addWidget(self.right_container)
